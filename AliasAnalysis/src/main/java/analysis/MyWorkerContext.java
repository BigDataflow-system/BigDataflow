...
//-----------------------------------------------------read from HDFS----------------------------------------------------------------
        ...
        try
        {
            ...
            // BufferedReader pa = new BufferedReader(readHDFS("hdfs://emr-header-1.cluster-332125:9000/analysis/start"));
            BufferedReader pa = new BufferedReader(readHDFS("hdfs://emr-header-1.cluster-334120:9000/analysis/start"));
            pa.readLine();
